...
- 📈 Аналитика с графиками (Pure SVG — быстрее и легче Recharts)
- 💳 Счета Monobank — балансы прямо на дашборде
- 🌓 Тёмная/светлая тема (переключатель в хедере — система/тёмная/светлая)
...
| Банк | Monobank API |
| Графики | Pure SVG (6KB, без Recharts) |
